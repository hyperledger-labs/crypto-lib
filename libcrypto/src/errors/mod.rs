...
impl fmt::Display for HLCryptoError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            HLCryptoError::InvalidParam5(ref description) => write!(f, "Invalid param 5: {}", description),
            HLCryptoError::InvalidParam6(ref description) => write!(f, "Invalid param 6: {}", description),
            HLCryptoError::InvalidParam7(ref description) => write!(f, "Invalid param 7: {}", description),
            HLCryptoError::InvalidParam8(ref description) => write!(f, "Invalid param 8: {}", description),
            HLCryptoError::InvalidParam9(ref description) => write!(f, "Invalid param 9: {}", description),
